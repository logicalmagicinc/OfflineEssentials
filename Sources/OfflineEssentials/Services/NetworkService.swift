...
//            print(str)
    ...
    public func POST<R: Codable>(url endpoint: String, token: String?) async -> Result<R, Error> {
        guard let url = URL(string: "\(baseUrl)/\(endpoint)") else {
            // TODO: swap this to the Error case.
            return .failure(NetworkError.invalidURL)
        }
...
//            print(str)
    ...
    public func DELETE<R: Codable>(url endpoint: String, token: String?) async -> Result<R, Error> {
        guard let url = URL(string: "\(baseUrl)/\(endpoint)") else {
            // TODO: swap this to the Error case.
            return .failure(NetworkError.invalidURL)
        }
